...
// Date: 12/6/2015
//
// Note: This source file and the header file, AIMeleeTile.h, are copied from Scott's
...
AIMeleeTile::AIMeleeTile(int InputXPosition, int InputYPosition, int FrameWidth, int FrameHeight,
		bool Collidable = true, bool Animated = true, bool Continuous = false, bool Looped = true, int AnimFPS =  6)
		: Sprite(al_load_bitmap("AI_Fireball.png"), InputXPosition, InputYPosition, FrameWidth, FrameHeight, Collidable, Animated, Continuous, Looped, AnimFPS)
{
