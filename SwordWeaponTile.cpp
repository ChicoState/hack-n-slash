...
//SwordWeaponTile Class CPP: Handles the sprite control for the sword weapon
...
void SwordWeaponTile::Draw(int DrawXCoordinate, int DrawYCoordinate, int XDirection, int YDirection, bool IsWeaponActive)
{
	...
	if (m_Image != NULL)
	{
		...
		if(IsWeaponActive)
		{
			DrawWeaponActive(DrawXCoordinate, DrawYCoordinate, XDirection, YDirection, IsWeaponActive);
		}

			//else if the weapon is not active draw this
		else
		{
			DrawWeaponInactive(DrawXCoordinate, DrawYCoordinate, XDirection, YDirection, IsWeaponActive);
		}
	}
}

//!Draws the weapon if it is active
//In - 
//		int DrawXCoordinate - DrawXCoordinate - the x coordinate to draw the weapon at
//		int DrawYCoordinate - DrawXCoordinate - the y coordinate to draw the weapon at
//		int XDirection - the x direction relative to the player/AI using the weapon to draw at (use graph coordinates to calculate (Ex. 0, 1 is North or Up))
//		int YDirection - the y direction relative to the player/AI using the weapon to draw at (use graph coordinates to calculate (Ex. 0, 1 is North or Up))
void SwordWeaponTile::DrawWeaponActive(int DrawXCoordinate, int DrawYCoordinate, int XDirection, int YDirection, bool IsWeaponActive)
{
	//draw sprite up
...
//!Draws the weapon if it is inactive
//In - 
//		int DrawXCoordinate - DrawXCoordinate - the x coordinate to draw the weapon at
//		int DrawYCoordinate - DrawXCoordinate - the y coordinate to draw the weapon at
//		int XDirection - the x direction relative to the player/AI using the weapon to draw at (use graph coordinates to calculate (Ex. 0, 1 is North or Up))
//		int YDirection - the y direction relative to the player/AI using the weapon to draw at (use graph coordinates to calculate (Ex. 0, 1 is North or Up))
void SwordWeaponTile::DrawWeaponInactive(int DrawXCoordinate, int DrawYCoordinate, int XDirection, int YDirection, bool IsWeaponActive)
{
	//draw sprite up
	if(XDirection == 0 && YDirection == -1)
	{
