...
protected:
	...
	int m_ProjectileXPosition; //the current x position of the projectile
	int m_ProjectileYPosition; //the current y position of the projectile
	...
	Direction m_CurrentProjectileDirection; //The direction of the projectile is moving during an attack 
