...
public:
	...
	bool CheckMapCollision(AVec2f); //checks to see if the given position collides with anything on the terrain
...
private:
	...
	void ClearFog(AVec2i, int); //recursive algorithm for removing all fog from a room once the player enters it
	void CreatePickupObjects(AVec2i); //tells the object manager to spawn an object
