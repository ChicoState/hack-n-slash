...
public:
	...
	TerrainTile& Get_Tile(AVec2i Pos) { return m_Layer[Pos.x()][Pos.y()]; } //returns a reference to the tile at the given index position 
	void Set_Tile(AVec2i Pos, TerrainTile Tile) { m_Layer[Pos.x()][Pos.y()] = Tile; } //Set the tile type of a tile at the given index position
	void SetTerrainImage();
